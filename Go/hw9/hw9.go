...
// Accepts filename from command line, reads file & loads URLs into string slice
// Start goroutine for each element in slice, wait 5-10 seconds for routines to complete
// Goroutine will fetch contents of webpage at given address, print URL, & length of web page body returned
// Checks for errors using Go idiomatic approach

// Extend program to extract web page title from data received using Go regular expression library functions
// Print title
